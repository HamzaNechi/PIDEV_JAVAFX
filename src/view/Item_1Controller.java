...
public class Item_1Controller implements Initializable {
    ...
    void AcheterTicket() throws IOException {
        ...
        co.setCourse_id(Integer.parseInt(cid.getText()));
     ...
     public void setData(course c) {
         ...
         imgg.setImage(i);
         Image ii=new Image("view/images/date1.png");
         img.setImage(ii);
        ...
        id.setText(idd);
        String cidString = Integer.toString(c.getCourse_id());
         cid.setText(cidString);      
    }
