...
public class Qualifying {
    ...
    public Qualifying(int qualifying_id, String q1, String q2, String q3, int position, Pilote pilote) {
    ...
    public Qualifying(int id,String q1, String q2, String q3, int position, Pilote pilote, course course) {
        this.qualifying_id=id;
        this.q1 = q1;
        this.q2 = q2;
        this.q3 = q3;
        this.position = position;
